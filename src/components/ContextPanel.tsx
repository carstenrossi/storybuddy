...
export default function ContextPanel() {
  ...
  // Lade Kontext-Dateien beim Start
  useEffect(() => {
    loadContextFiles();
  }, []);
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 h-full flex flex-col">
      <div className="p-4 border-b border-gray-200 dark:border-gray-700">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            title="Neue Kontext-Datei erstellen"
          >
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        ...
        {/* Separate Kapitel-Sektion */}
        {contextFiles.filter(file => file.type === 'chapter').length > 0 && (
        ...
        {/* Bestehende Kontext-Dateien (ohne Kapitel) */}
        {contextFiles.filter(file => file.type !== 'chapter').length > 0 && (
          <div>
            <div className="flex items-center space-x-2 mb-3">
        ...
        {contextFiles.length === 0 && !isCreating && (
          <div className="text-center py-8 text-gray-500 dark:text-gray-400">
            <FileText className="h-8 w-8 mx-auto mb-2 opacity-50" />
            <p className="text-sm">Noch keine Kontext-Dateien erstellt</p>
